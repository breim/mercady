...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { address: @market.address, cnpj: @market.cnpj, latitude: @market.latitude, longitude: @market.longitude, name: @market.name }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { address: @market.address, cnpj: @market.cnpj, latitude: @market.latitude, longitude: @market.longitude, name: @market.name }
    assert_redirected_to market_path(assigns(:market))
  end
